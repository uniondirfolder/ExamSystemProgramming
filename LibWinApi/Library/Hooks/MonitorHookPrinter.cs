...
namespace LibWinApi.Library.Hooks
{
    ...
    public class PrintHookEventArgs : EventArgs
    {
        public PrintEventData EventData { get; set; }
    }
    public class MonitorHookPrinter
    {
        private readonly object accesslock = new object();

        private readonly SyncHookFactory factory;
        ...
        public event EventHandler<PrintHookEventArgs> OnPrintEvent;
        ...
        private void pqm_OnJobStatusChange(object sender, PrintJobChangeEventArgs e)
        {
                ...
                && e.JobInfo != null)
            {
                ...
                Task.Run(() => OnPrintEvent?.Invoke(null, new PrintHookEventArgs { EventData = printEvent }));
            }
        }
    }
